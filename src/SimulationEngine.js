...
export const DEFAULTS = {
  ...
  // Weight parameters
  w_exc: 0.8,            // Within-group excitatory weight
  w_inh: 0.6,            // Between-group lateral inhibition weight
  w_rec_inh: 0.4,        // Within-group recurrent inhibition weight
  w_drive_inh: 1.0,      // Excitatory drive to interneurons (internal)

  // Input parameters
  I_stim: 2.5,           // External current
